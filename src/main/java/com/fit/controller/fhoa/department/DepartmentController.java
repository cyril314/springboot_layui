package com.fit.controller.fhoa.department;

import com.fit.controller.base.BaseController;
import com.fit.entity.Page;
import com.fit.service.fhoa.department.DepartmentManager;
...
public class DepartmentController extends BaseController {
    ...
    public ModelAndView list(HttpServletRequest request, Page page) throws Exception {
        ...
        mv.addObject("count", page.getTotalResult());
        mv.addObject("varList", getListHash(varList));
    ...
    public ModelAndView listAllDepartment(HttpServletRequest request, Model model, String DEPARTMENT_ID) throws Exception {
        ModelAndView mv = this.getModelAndView(request);
        PageData pd = this.getPageData();
        try {
            String json = FastJsonUtil.toJSONString(departmentService.listAllDepartment("0"));
            json = json.replaceAll("DEPARTMENT_ID", "id").replaceAll("PARENT_ID", "pId")
                    .replaceAll("NAME", "name").replaceAll("subDepartment", "children")
                    .replaceAll("hasDepartment", "checked").replaceAll("treeurl", "url");
