...
public class FhfileController extends BaseController {
    ...
    public ModelAndView save() throws Exception {
        ...
        pd.put("CTIME", DateUtil.getTime());                //上传时间
    ...
    public ModelAndView goViewTxt() throws Exception {
        ...
        pd = fhfileService.findById(pd);
        String code = FileUtil.readTxtFile(Const.FILEPATHFILEOA + pd.getString("FILEPATH"), encoding);
        pd.put("code", code);
    ...
    public void download(HttpServletResponse response) throws Exception {
        ...
        FileUnitUtil.fileDownload(response, PathUtil.getClasspath() + Const.FILEPATHFILEOA + fileName, pd.getString("NAME") + fileName.substring(19, fileName.length()));
    }
