package com.fit.controller.fhoa.staff;
...
public class StaffController extends BaseController {
    ...
    public ModelAndView list(HttpServletRequest request, Page page) throws Exception {
        ...
        ZDEPARTMENT_ID = StringUtil.isNotEmpty(ZDEPARTMENT_ID) ? ZDEPARTMENT_ID : Jurisdiction.getDEPARTMENT_ID();
        pd.put("ZDEPARTMENT_ID", ZDEPARTMENT_ID);
        List<PageData> zdepartmentPdList = new ArrayList<PageData>();
        JSONArray arr = FastJsonUtil.objParseJsonArray(departmentService.listAllDepartmentToSelect(ZDEPARTMENT_ID, zdepartmentPdList));
    ...
    public ModelAndView goAdd() throws Exception {
        ...
        pd = this.getPageData();
        List<PageData> zdepartmentPdList = new ArrayList<PageData>();
        JSONArray arr = FastJsonUtil.objParseJsonArray(departmentService.listAllDepartmentToSelect(Jurisdiction.getDEPARTMENT_ID(), zdepartmentPdList));
