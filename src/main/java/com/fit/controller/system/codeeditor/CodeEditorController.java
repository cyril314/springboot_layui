package com.fit.controller.system.codeeditor;

import com.fit.config.shiro.Jurisdiction;
import com.fit.controller.base.BaseController;
import com.fit.entity.Page;
import com.fit.entity.PageData;
import com.fit.service.system.codeeditor.CodeEditorManager;
import com.fit.util.*;
...
public class CodeEditorController extends BaseController {
    ...
    public Object getCode() {
        ...
        try {
            ...
            String code = FileUtil.readTxtFile("/ftl/" + type + "/" + ftlNmame + ".ftl");    //从原始模版获取
    ...
    public Object save() {
        ...
        try {
            ...
            String type = pd.getString("type");
            String ftlNmame = pd.getString("ftlNmame");
            FileUtil.writeFile("/ftl/" + type + "/" + ftlNmame + ".ftl", codeTxt);    //写入到文件
            pd.put("TYPE", type);
    ...
    public Object reduction() {
        ...
        try {
            ...
            if ("fromHistory".equals(msg)) {
                ...
                code = FileUtil.readTxtFile("/ftl_backups/" + type + "/" + ftlNmame + ".ftl");    //从原始模版获取
            }
            FileUtil.writeFile("/ftl/" + type + "/" + ftlNmame + ".ftl", code);                        //写入到现在模版
            map.put("code", code);
        } catch (Exception e) {
            logger.error(e.toString(), e);
        } finally {
