package com.fit.controller.system.buttonrights;
...
public class ButtonrightsController extends BaseController {
    ...
    public ModelAndView list(HttpServletRequest request) throws Exception {
        ...
        mv.addObject("buttonlist", getListHash(buttonlist));
        mv.addObject("roleFhbuttonlist", getListHash(roleFhbuttonlist));
