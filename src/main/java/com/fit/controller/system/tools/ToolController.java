package com.fit.controller.system.tools;
...
public class ToolController extends BaseController {
    ...
    public ModelAndView editEmail(HttpServletRequest request) throws Exception {
    ...
    public void downloadFormCode(HttpServletResponse response) throws Exception {
        ...
        FileUnitUtil.fileDownload(response, PathUtil.getClasspath() + "admin/ftl/code/newJsp.jsp", "newJsp.jsp");
    }
    ...
    public void upload(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String fileNmae = request.getParameter("file");
        String name = "";
        String extName = "";
        for (FileItem item : fileList) {
            if (!item.isFormField()) {
                ...
                if (null != fileNmae && !"".equals(fileNmae)) {
                    ...
                    do {
                        name = DateUtil.getAllTime();    //获取当前日期
        ...
        map.put("code", 0);
        if (null != fileNmae && !"".equals(fileNmae)) {
            map.put("data", fileNmae);
        } else {
            map.put("data", (name.trim() + extName.trim()).trim());
        }
