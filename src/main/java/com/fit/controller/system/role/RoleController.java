package com.fit.controller.system.role;
...
public class RoleController extends BaseController {
    ...
    public Object getRole(String id) {
        ...
        try {
            ...
            map.put("roleList_z", roleList_z); // 返回结果
        } catch (Exception e) {
            e.printStackTrace();
            errInfo = "error";
            errCode = 1000;
    ...
    public ModelAndView listAllMenu(Model model, String ROLE_ID) throws Exception {
        ...
        try {
            ...
            String json = FastJsonUtil.toJSONString(menuList);
    ...
    public void saveMenuqx(@RequestParam String ROLE_ID, @RequestParam String menuIds, HttpServletResponse response) throws Exception {
        ...
        try {
            if (null != menuIds && !"".equals(menuIds.trim())) {
                BigInteger rights = RightsHelper.sumRights(StringUtil.str2StrArray(menuIds));//用菜单ID做权处理
