...
import com.fit.service.system.createcode.CreateCodeManager;
import com.fit.util.*;
...
/**
 * 类名称： 代码生成器 创建人： 修改时间：2015年11月23日
 */
@Controller
...
public class CreateCodeController extends BaseController {
    ...
    public void proCode(HttpServletResponse response) throws Exception {
        ...
        if ("tree".equals(FHTYPE)) {
            ...
            /* 生成jsp_tree页面 */
            Freemarker.printFile("jsp_tree_Template.ftl", root, "jsp/" + packageName + "/" + objectName.toLowerCase() + "/" + objectName.toLowerCase()
                    + "_tree.jsp", filePath, ftlPath);
        ...
        /* 生成service */
        Freemarker.printFile("serviceTemplate.ftl", root, "service/" + packageName + "/" + objectName.toLowerCase() + "/impl/" + objectName + "Service.java",
                filePath, ftlPath);
        /* 生成manager */
        Freemarker.printFile("managerTemplate.ftl", root, "service/" + packageName + "/" + objectName.toLowerCase() + "/" + objectName + "Manager.java",
                filePath, ftlPath);
        /* 生成mybatis xml */
        ...
        if (FileZip.zip(PathUtil.getClasspath() + "admin/ftl/code", PathUtil.getClasspath() + "admin/ftl/code.zip")) {
            /* 下载代码 */
            FileUnitUtil.fileDownload(response, PathUtil.getClasspath() + "admin/ftl/code.zip", "code.zip");
        }
    }
