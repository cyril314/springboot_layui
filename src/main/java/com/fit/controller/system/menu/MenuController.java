package com.fit.controller.system.menu;
...
public class MenuController extends BaseController {
    ...
    public ModelAndView listAllMenu(HttpServletRequest request, Model model, String MENU_ID) throws Exception {
        ModelAndView mv = this.getModelAndView(request);
        try {
            String json = FastJsonUtil.toJSONString(menuService.listAllMenu("0"));
            json = json.replaceAll("MENU_ID", "id").replaceAll("PARENT_ID", "pId")
                    .replaceAll("MENU_NAME", "name").replaceAll("subMenu", "children")
    ...
    public ModelAndView otherlistMenu(Model model, String MENU_ID) throws Exception {
        ...
        try {
            ...
            String json = FastJsonUtil.toJSONString(athmenuList);
