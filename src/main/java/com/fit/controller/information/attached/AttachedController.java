package com.fit.controller.information.attached;

import com.fit.config.shiro.Jurisdiction;
import com.fit.controller.base.BaseController;
import com.fit.entity.Page;
import com.fit.entity.PageData;
import com.fit.service.information.attached.AttachedManager;
...
public class AttachedController extends BaseController {
    ...
    public Object list(Page page) throws Exception {
        ...
        try {
            ...
            page.setPd(pd);
            List<PageData> varList = attachedService.list(page);        //列出会员列表
