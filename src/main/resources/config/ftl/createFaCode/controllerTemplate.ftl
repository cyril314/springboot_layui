package com.aim.controller.${packageName}.${objectNameLower};
...
import com.aim.controller.base.BaseController;
import com.aim.entity.Page;
import com.aim.util.AppUtil;
import com.aim.util.ObjectExcelView;
import com.aim.util.PageData;
import com.aim.util.Jurisdiction;
import com.aim.util.StringUtil;
import com.aim.service.${packageName}.${objectNameLower}.${objectName}Manager;
import com.aim.service.${packageName}.${objectNameLower}mx.${objectName}MxManager;
...
<#list fieldList as var>
	<#if var[3] == "否">
		<#if var[1] == 'Date'>
		pd.put("${var[0]}", StringUtil.date2Str(new Date()));	//${var[2]}
